import { CharacterPF2e } from "../pf2e/character";
...
declare global {
  ...
  declare class Hooks {
    ...
    static on(
      hook: "renderCharacterConfig",
      fn: (
        app: Application,
        form: JQuery<HTMLDivElement>,
        data: {
          alliances: unknown;
          cssClass: string;
          data: ReturnType<foundry.abstract.DataModel["toObject"]>;
          document: CharacterPF2e;
        }
      ) => any
    ): number;
